<template>
  <div class="box">
    <div class="search-box">
      <auto-complete :entryList="entryList" @search="search"></auto-complete>
    </div>
    <div class="news-list">
  ...
  export default Vue.extend({
    ...
    data() {
      return {
        ...
        newsList: [
          {id: 1, title: '嗨', content: '内容xxx', date: '三天前', cover: 'https://img0.baidu.com/it/u=2064213898,2801034448&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=500'},
